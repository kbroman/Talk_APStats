...
\begin{frame}[c]{
  \only<1>{Growth curves}
  \only<2|handout 0>{{\Fone} males}
  \only<3|handout 0>{{\Fone} females}
  \only<4|handout 0>{{\Ftwo} males}
  \only<5|handout 0>{{\Ftwo} females}
}

\only<1>{\figw{Figs/growth1.pdf}{1.0}}
\only<2|handout 0>{\figw{Figs/growth2.pdf}{1.0}}
\only<3|handout 0>{\figw{Figs/growth3.pdf}{1.0}}
\only<4|handout 0>{\figw{Figs/growth4.pdf}{1.0}}
\only<5|handout 0>{\figw{Figs/growth5.pdf}{1.0}}
